...
fun PrivacyAgreementScreen(
    ...
    // 비활성 타이머 관리 (타이머 상태를 입력 폼과 분리)
    var inactivityTrigger by remember { mutableStateOf(0) }
    val resetInactivityTimer: () -> Unit = { inactivityTrigger++ }
    ...
    LaunchedEffect(privacyAgreed) {
        if (privacyAgreed == true) {
            ...
            employeeCardRef.value?.let { position -> scrollState.animateScrollTo(position) }
        }
        // 사용자 활동 감지
                    ...
                    Column(modifier = Modifier.fillMaxWidth().padding(16.dp)) {
                        ...
                        AccordionCard(
                                ...
                                content = {
                                    ...
                                    val htmlFilePath = "privacy_policy_$language.html"
                                    ...
                                    Box(
                                        ...
                                        HtmlContent(
                                                ...
                                                fallbackContent = AppStrings.privacyPolicyContent,
                            ...
                            OutlinedTextField(
                                    ...
                                    modifier =
                                            Modifier.fillMaxWidth().onFocusChanged {
                                                if (it.isFocused) resetInactivityTimer()
                                            },
                                    enabled = false,
                                    singleLine = true,
                                    trailingIcon = {
                                        IconButton(
                                                onClick = { viewModel.resetEmployeeVerification() }
                                        ) { Icon(Icons.Default.Edit, contentDescription = "다시 입력") }
                                    }
                            )
                                    ...
                                    keyboardActions =
                                            KeyboardActions(
                                                    onDone = {
                                                        ...
                                                        if (formState.employeeName.isNotBlank()) {
                                                            viewModel.verifyEmployee()
                                                        }
                                                    }
                                            ),
                                    trailingIcon = {
                                ...
                                Text(
                                        text =
                                                buildAnnotatedString {
                                                    ...
                                                    append(AppStrings.visitorNameLabel)
                                                },
                                        style = MaterialTheme.typography.bodySmall,
                        ...
                        Row(
                            ...
                            Column(modifier = Modifier.weight(1f)) {
                                ...
                                Text(
                                        text =
                                                buildAnnotatedString {
                                                    ...
                                                    append(AppStrings.visitorContactLabel)
                                                },
                                        style = MaterialTheme.typography.bodySmall,
                                        modifier = Modifier.padding(bottom = 4.dp)
                                )
                                ...
                                OutlinedTextField(
                                        ...
                                        singleLine = true,
                                        placeholder = { Text(AppStrings.numbersOnlyPlaceholder) }
                                )
                            ...
                            Column(modifier = Modifier.weight(1f)) {
                                Text(
                                        text = AppStrings.visitorCarNumberLabel,
                                        style = MaterialTheme.typography.bodySmall,
                                        modifier = Modifier.padding(bottom = 4.dp)
                                )
                        ...
                        Text(
                                text =
                                        buildAnnotatedString {
                                            ...
                                            append(AppStrings.visitPurposeLabel)
                                        },
                                style = MaterialTheme.typography.bodyLarge,
                                modifier = Modifier.padding(bottom = 8.dp)
                        )
